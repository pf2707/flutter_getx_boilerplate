...
class AnimatedFadeTextWidget extends StatefulWidget {
  final String text;
  final TextStyle? textStyle;
  final Function? onAnimationComplete;
  const AnimatedFadeTextWidget({super.key, required this.text, this.textStyle, this.onAnimationComplete});

  @override
  State<AnimatedFadeTextWidget> createState() => _AnimatedFadeTextWidgetState();
}

class _AnimatedFadeTextWidgetState extends State<AnimatedFadeTextWidget> with SingleTickerProviderStateMixin {
